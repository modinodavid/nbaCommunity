package org.modino.nbaCommunityWeb.controller.auth;
...
//                SavedRequest savedRequest = (SavedRequest) session.getAttribute(WebAttributes.SAVED_REQUEST);
            	SavedRequest savedRequest = (SavedRequest) session.getAttribute(WebAttributes.WEB_INVOCATION_PRIVILEGE_EVALUATOR_ATTRIBUTE);
